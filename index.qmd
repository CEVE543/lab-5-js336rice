...
Location and Scale provides a much more accurate picture of uncertainty than the Location only model.  This is because trends in CO_2 are changing not just the severity of extreme weather (location) but also its variance (scale), and giving us fatter tails. The difference between the two models reflects this, with the 100-year return levels in the location and scale model. having a wider, flatter distribution than those of the location only model.  
