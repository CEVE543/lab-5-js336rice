...
It seems like regional parameter estimation is much better.  The only condition in which single-station would be preferred is if you both cared a lot about storm behavior in one specific location, and also had a very long data record in that area. 
